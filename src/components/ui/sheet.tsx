	...
	return (
		<SheetPortal>
			...
			<SheetPrimitive.Content
				className={cn(
					'bg-background/90 data-[state=open]:animate-in data-[state=closed]:animate-out fixed z-50 flex flex-col gap-4 shadow-lg backdrop-blur-lg transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500',
					side === 'right' &&
